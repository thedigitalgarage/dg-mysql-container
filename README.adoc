...
== Overview
http://www.thedigitalgarage.io[Digital Garage] provides a container image for running MySQL. This image can
provide database services based on username, password, and database name
settings provided via configuration.

== Versions
Currently, Digital Garage provides version
...
registries or push them into your Digital Garage container registry. Additionally,
you can create an ImageStream that points to the image,
either in your Docker registry or at the external location. Your Digital Garage
...
ImageStream definitions for all the provided Digital Garage images.
...
http://docs.thedigitalgarage.io/architecture/core_concepts/pods_and_services.html#pods[pod] with
...
is used when a container does not have http://docs.thedigitalgarage.io/dev_guide/compute_resources.adoc#dev-memory-limits[memory limits]
...
http://docs.thedigitalgarage.io/dev_guide/deployments.adoc#config-change-trigger[configuration change
...
Digital Garage provides a http://docs.thedigitalgarage.io/dev_guide/templates.adoc#dev-guide-templates[template] to make
...
http://docs.thedigitalgarage.io/architecture/core_concepts/deployments.adoc#deployments-and-deployment-configurations[deployment
configuration] and a
http://docs.thedigitalgarage.io/architecture/core_concepts/pods_and_services.adoc#services[service].
...
persistent volume pool be defined in the Digital Garage deployment.

You can find instructions for instantiating templates by following these
http://docs.thedigitalgarage.io/dev_guide/templates.adoc#dev-guide-templates[instructions].
...
Digital Garage provides a proof-of-concept developed by Red Hat
http://docs.thedigitalgarage.io/architecture/core_concepts/templates.adoc#architecture-core-concepts-templates[template] for MySQL
...
http://docs.thedigitalgarage.io/architecture/core_concepts/deployments.adoc#replication-controllers[replication
...
causes Digital Garage to start only one instance of the server. Multiple
...
To http://docs.thedigitalgarage.io/dev_guide/deployments.adoc#scaling[increase the number of members]
in the cluster:
